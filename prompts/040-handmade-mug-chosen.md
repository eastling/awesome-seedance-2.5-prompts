---
id: SD25-040
slug: handmade-mug-chosen
title: The Handmade Mug Gets Chosen
title_zh: 被选中的手作陶杯
description: A handmade clay mug waits behind perfect porcelain cups in a 30-second stylized 3D short, using three image references, tightly locked character animation, and a 13-segment emotional storyboard.
description_zh: 一只手作陶杯在完美的瓷杯后方等待被选择；这支 30 秒风格化 3D 短片使用三张参考图、严格限定的角色动画和 13 段情绪分镜。
model: Seedance 2.5
source_type: community
source_publisher: Dheepan Ratnam (@Dheepanratnam)
source_url: https://x.com/Dheepanratnam/status/2083869160677704006
prompt_source_url: https://x.com/Dheepanratnam/status/2083869167791305173
...
video_url: https://x.com/Dheepanratnam/status/2083869160677704006
---
