---
id: SD25-051
slug: sticker-fashion-transformations
title: Sticker Fashion Transformations
title_zh: 贴纸式时尚换装
description: A 30-second vertical fashion editorial uses four fixed outfit stickers, a mouse cursor, and full-body fly-in overlaps to transform one consistent protagonist through five K-pop-inspired looks.
description_zh: 一段 30 秒竖屏时尚短片，以四个固定服装贴纸、鼠标指针和全身贴纸飞入重叠机制，让同一位女主角连续切换五套韩系偶像造型。
model: Seedance 2.5
source_type: community
source_publisher: BubbleBrain (@BubbleBrain)
source_url: https://x.com/BubbleBrain/status/2083939966594527607
prompt_source_url: https://x.com/BubbleBrain/status/2083939966594527607
